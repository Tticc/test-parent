...
public class EventHandle_Silot {
    ...
    public static PointInfoDTO silot_return_p2 = new PointInfoDTO().setX(1727).setY(846);
    public static PointInfoDTO silot_return_p3 = new PointInfoDTO().setX(1787).setY(877);
