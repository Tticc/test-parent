...
public class EventHandle_Sai {
    ...
    public static PointInfoDTO sai_return_p2 = new PointInfoDTO().setX(1722).setY(866);
    public static PointInfoDTO sai_return_p3 = new PointInfoDTO().setX(1799).setY(878);
