            ...
            if (null == st && null == ed) {
                ...
                if (OkxCommon.checkIfMABuySign(tradeInfo)) {
                    if (lastIsMa) {
                        ...
                        System.out.println("买入信号。价格:" + tradePrice + "(上一轮" + st + "), open时间:" + DateUtil.dateFormat(tradeTime));
                    ...
                    if (lastIsMa) {
                        int profits = ed - st;
                        System.out.println("收益:" + profits);
                        System.out.println("卖出信号。价格:" + tradePrice + "(上一轮" + st + "), open时间:" + DateUtil.dateFormat(tradeTime));
                        peocessList(changeList, profitsList, tradeFeeList, profits, fee, skip, defaultSkipNumber, tradeParam.getSkipAfterHuge(), tradeParam.getKeepSkipAfterHuge());
                    } else {
                    ...
                    int profits = ed - st;
                    System.out.println("收益:" + profits);
                    System.out.println("止盈止损卖出信号。价格:" + tradePrice + "(上一轮" + st + "), open时间:" + DateUtil.dateFormat(tradeTime));
                    peocessList(changeList, profitsList, tradeFeeList, profits, fee, skip, defaultSkipNumber, tradeParam.getSkipAfterHuge(), tradeParam.getKeepSkipAfterHuge());
                }
            }
            BigDecimal multiply = DecimalUtil.toDecimal(tradePrice).multiply(tradeParam.getSkipTimes());
